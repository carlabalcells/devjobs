            ...
            <div class="flex flex-col break-words bg-white border shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="flex flex-wrap mb-6">
                            ...
                            class="p-3 bg-gray-200 rounded form-input w-full @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password" 
                            class="p-3 bg-gray-200 rounded form-input w-full @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        class="p-3 bg-gray-200 rounded form-input w-full" name="password_confirmation" required autocomplete="new-password">
                        
                        
                    </div>

                     <div class="flex flex-wrap mb-6">
                        <button type="submit" class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase">
                            {{ __('Reset Password') }}
                        </button>
                    </div>
                </form>
